...
case ('шаг 1'):
case ('/step_1'):
sendMessage($chat_id, 'Это первый вид РЕАЛЬНОГО заработка в интернете. ' , $replyMarkupStep1 );
break;
case ('Копирайтинг'):
