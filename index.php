...
$replyMarkupStep2 = array(
  'keyboard' => array(
      ...
      array("Заработок на разговорах", "Биржа голосов в ВК"),
      array("Назад")
  ),
  'resize_keyboard' => true, 
);
...
break;
case ('биржа голосов в вк'):
sendMessage($chat_id, 'Тоже простой вид заработка. Ты ставишь лайки, делаешь репосты и тебе за это платят деньги. Правда, мало. Я со средней активностью насобирала 100 рублей за неделю. Но это так, зашла в приложение, проставила лайки, вышла. Около 5 минут в день. Мелочь, а приятно. Кстати, эти 100 рублей я пустила на раскрутку страницы инстаграмм, что тоже неплохо) 
Однако, надо быть внимательными. Буквально недавно ВК стал блокировать страницы, которые зарегистрированы в подобных приложениях. Я устанавливала https://vktarget.ru Советую вам не привязывать страницу в ВК. Работайте с инстаграмом, фейсбуком, одноклассниками и твитером. Еще есть сайт http://vkstorm.ru http://vkmix.com Подобных сайтов много.', $encodedMarkupStep2 );
break;
case ('шаг 3'):
case ('/step_3'):
